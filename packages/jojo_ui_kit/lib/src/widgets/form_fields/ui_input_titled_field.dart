...
class UiInputTitledField<T> extends StatelessWidget {
  const UiInputTitledField({
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                    right: Insets.l,
                    top: Insets.l,
                    child: _getSuffixIconWidget(context) ??
    ...
    return ReactiveTextField<T>(
      ...
      decoration: InputDecoration(
        ...
        border: OutlineInputBorder(
          borderRadius:
              BorderRadius.circular((minLines ?? 1) > 1 ? Insets.l : 28.0),

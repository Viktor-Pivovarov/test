import 'package:jojo_sdk/src/user_agent_parser/browser.dart';
import 'package:jojo_sdk/src/user_agent_parser/browser_parser.dart';
import 'package:jojo_sdk/src/user_agent_parser/result.dart';
    ...
    for (final BrowserParser browserParser in browserParsers) {
      for (final String regex in browserParser.regexes) {
        ...
        if (regExp.hasMatch(userAgent)) {
          ...
          final String? unformattedName = matches.first.namedGroup('unformattedName');

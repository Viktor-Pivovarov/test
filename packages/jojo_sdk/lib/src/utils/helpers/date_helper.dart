...
abstract class DateHelper {
  ...
  static String formatToLocalTime(DateTime date) {
  ...
  static String formatToYMDWithTime(DateTime date) {
  ...
  static bool isToday(DateTime date) => calculateDifference(date) == 0;

  static bool isYesterday(DateTime date) => calculateDifference(date) == -1;
}
